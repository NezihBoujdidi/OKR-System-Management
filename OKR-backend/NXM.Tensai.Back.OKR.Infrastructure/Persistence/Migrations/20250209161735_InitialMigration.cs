...
public partial class InitialMigration : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_OKRSessions", x => x.Id);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_Objectives_OKRSessions_OKRSessionId",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_KeyResultTasks", x => x.Id);
                table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_KeyResultTasks_KeyResults_KeyResultId",
        ...
        migrationBuilder.CreateIndex(
            name: "IX_KeyResultTasks_KeyResultId",
        ...
        migrationBuilder.CreateIndex(
            name: "IX_Objectives_OKRSessionId",
            table: "Objectives",
            column: "OKRSessionId");
